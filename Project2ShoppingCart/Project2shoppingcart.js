...
function checkout_selection(x) {
    alert("Thank you for your order. Your total is: R" + totalOrderAmt);
...
function display_all() {
    ...
    myTable += "</table>";
    myTable += "<br/><br/><p>Thank you for your order! <br/>Total: R" + totalOrderAmt + "</p>";
    myTable += "<td><button onclick='checkout_selection(" + totalOrderAmt + ")'>Checkout</button></td>";
